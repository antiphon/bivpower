...
#'
#' @details If n is missing, use thinning of the dominating Poisson process.
#' If n given, use a Metropolis-Hastings starting from uniformly distributed pattern.
#'
